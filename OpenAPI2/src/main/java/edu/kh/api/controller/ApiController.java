...
public class ApiController {
	...
	/**
	 * Ajax로 OpenAPI 요청하는 페이지로 forward
	 * @return
	 */
	@GetMapping("ex1")
	public String ex1() {
	...
	public String ex2(
		...
		String serviceKey = "UYby5Ax2DC7489LtFL15X9tRnaTCrXpWMJRESvSHZATw8rQG8nqxPlDHIrUb6clAZapqyEdohQjyLn6BimM6jg==";
...
//		날씨 API의 공공데이터 샘플 JAVA 코드 복사
		
		// StringBuilder : String의 단점(불변성)을 해결한 객체
		StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getUltraSrtFcst"); /*URL*/
		
		// 주소?serviceKey=서비스키
		// String.valueOf() : encode는 String 형태만 들어갈 수 있는데 들어가야 하는 값이 int일 경우 이를 String 형태로 바꿔준다.
        ...
        urlBuilder.append("&" + URLEncoder.encode("base_date","UTF-8") + "=" + URLEncoder.encode(baseDate, "UTF-8")); /*‘24년 5월 21일 발표*/
        ...
        System.out.println("Response code: " + conn.getResponseCode()); // 응답 상태 코드(200 : 성공 / 404 : 페이지 찾을 수 없음 등등)
        
        BufferedReader rd;
        
        
        // 응답상태 코드가 200~300인 경우(= 요청 성공)
        // InputStreamReader : 바이트 기반 입력 스트림을 문자 기반으로 변경. 문자 형태로 빨리 입력 받기 위한 준비(응답 데이터 빨리 받기)
        ...
        conn.disconnect(); // 외부 요청 연결 반환(연결 끊기)
        ...
        // Jackson : Json <-> DTO/map 라이브러리와 바꿀 수 있음
        ...
        System.out.println(j1.getString("response"));
