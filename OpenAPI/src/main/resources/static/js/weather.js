...
/* select 변경 시 해당 지역 날씨를 조회 */
region.addEventListener("change", e => {

    regionName.innerText = e.target.value;

    getUltraSrtNcst(e.target.value); // 해당 날씨 조회
});
