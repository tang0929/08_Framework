...
public class TestController {
	...
	// 기존 Servlet은 클래스 단위 하나의 요청만 처리 가능
	
	// Spring : 메서드 단위로 요청 처리 가능
	
	// @RequestMapping("요청"); : 요청 주소를 처리할 메서드를 매핑하는 어노테이션
	
	
	
	// 1) 메서드에 작성 : 요청 주소와 메서드를 매핑. GET/POST 가리지 않고 매핑( 속성을 통해 지정 가능)
	...
	*/ 
	...
	public String testMethod() {
		...
		/*
		 * Controller 메서드의 반환형이 String으로 거의 무조건 하라고 하는 이유
		 * 
		...
		/* 접두사, 접미사, forward 설정은 View Resolver 객체가 담당한다*/
	}
